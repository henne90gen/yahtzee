...
function SettingsButton(props: { isSettingsOpen: boolean }) {
    const dispatch = useDispatch();
    const buttonClasses = "absolute top-8 right-10"
    if (props.isSettingsOpen) {
        return <button className={buttonClasses} onClick={() => dispatch(closeSettings())}>
        ...
        return <button className={buttonClasses} onClick={() => dispatch(openSettings())}>
